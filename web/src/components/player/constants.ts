...
// 弹幕区顶部留白（占播放器高度比例），避免第一行弹幕贴住窗口上沿
export const DANMU_AREA_TOP_MARGIN = 0.08;
...
export const ICONS = {
  ...
  // 镜像翻转两态自造图形对：外高内矮的竖边梯形对 + 中缝虚线；实心版 = 镜像生效中。
  // 梯形比 lucide/tabler 的三角形墨量大，小尺寸（18px）下描边/实心的形态差异更明显；
  // 内缘 11 格（略过外缘半高）——收得再矮小尺寸会糊成半圆，再高就失去收腰感
  mirrorFlip: createLucideIconSvg('dtv-flip-mirror', '<path d="m4 2 5 4.5v11l-5 4.5Z"></path><path d="m20 2-5 4.5v11l5 4.5Z"></path><path d="M12 20v2"></path><path d="M12 14v2"></path><path d="M12 8v2"></path><path d="M12 2v2"></path>'),
  mirrorFlipFilled: createLucideIconSvg('dtv-flip-mirror-filled', '<path d="m4 2 5 4.5v11l-5 4.5Z" fill="currentColor"></path><path d="m20 2-5 4.5v11l5 4.5Z" fill="currentColor"></path><path d="M12 20v2"></path><path d="M12 14v2"></path><path d="M12 8v2"></path><path d="M12 2v2"></path>'),
